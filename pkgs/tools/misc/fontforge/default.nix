...
stdenv.mkDerivation rec {
  ...
  patches = [(fetchpatch {
    ...
    url = "https://raw.githubusercontent.com/PhantomX/slackbuilds/40790d8deabf1d08449529bad67c236cc3149224/fontforge/patches/fontforge-20140813-use-system-uthash.patch";
